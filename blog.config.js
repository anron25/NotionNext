...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我們這裡提供多種金融投資的方法，歡迎來到我們的blog🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'N1130401', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一群普通的大學生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || ' ', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '金融投資, 投資', // 网站关键词 英文逗号隔开
  ...
  NOTION_PROPERTY_NAME: {
    ...
    type_notice:
      process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE_NOTICE || ' ', // 当type文章类型与此值相同时，为公告。
